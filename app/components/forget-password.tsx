...
export function ForgetPassword() {
  ...
  // 如果使用WebsiteConfig，可以下发，这里改为默认使用邮箱验证码方式注册。@lizhen
  // const registerType = registerTypes[0];
  const registerType = REG_TYPE_USERNAME_AND_EMAIL_WITH_CAPTCHA_AND_CODE;
      ...
      <div className={styles["register"]}>
        <List>
          ...
          <ListItem>
            <IconButton
              type="primary"
              text={Locale.ForgetPasswordPage.ForgetPassword}
              block={true}
